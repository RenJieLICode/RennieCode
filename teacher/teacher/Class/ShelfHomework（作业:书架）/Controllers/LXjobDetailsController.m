...
#import "LXjobDetailsController.h"
#import "LXDoHomeworController.h"
@interface LXjobDetailsController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>

@end
static NSString *const jobDetailsItemID = @"jobDetails";
static NSString *const headID = @"head";
@implementation LXjobDetailsController
- (IBAction)startClick:(UIButton *)sender
{
    LXDoHomeworController *vc = [[LXDoHomeworController alloc]init];
...
//    flowLayout.scrollDirection = UICollectionViewScrollDirectionVertical;
    ...
    [collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:jobDetailsItemID];
...
{
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:jobDetailsItemID forIndexPath:indexPath];
